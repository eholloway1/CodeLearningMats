...
/*
	...
	Get chapt 9.7.4 date to run. test with date June 25, 1978 and one bad date.
	Date check can be simple and ingore leap years. Check for month in [1,12] range and date in [1,31]
	
	const member functions are the addition in 9.7.4 which I added earlier to make the ostream 
	<< overload function
*/
enum class Month {
