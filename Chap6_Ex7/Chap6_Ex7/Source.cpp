...
vector<char> getInput() { //ask user to enter their guess of the four characters
	...
	while (index < 4) {
		if (cin >> entry) {
			...
			error("Please enter a valid character for your guess");
		}
	}
	return in;
}
...
void checkInput(vector<char> in) { //check the input against the program-generated solution
